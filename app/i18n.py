...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "btn.export_month": "Export current month (JSON)",
        "btn.export_all": "Export all (JSON)",
    ...
    "de": {
        ...
        "btn.export_month": "Aktuellen Monat exportieren (JSON)",
        "btn.export_all": "Alles exportieren (JSON)",
