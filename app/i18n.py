...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "btn.export": "Export",
        "btn.export_latest": "Latest state",
        "btn.export_all": "Entire history",
        "export.hint": "Copies JSON to the clipboard",
        "export.exclude_preview": "Exclude preview updates",
    ...
    "de": {
        ...
        "btn.export": "Export",
        "btn.export_latest": "Letzter Stand",
        "btn.export_all": "Gesamter Verlauf",
        "export.hint": "Kopiert JSON in die Zwischenablage",
        "export.exclude_preview": "Ohne Preview-Updates",
